...
\`\`\`json
{
  "macos": "composer create-project under/framework mon-projet",
  "windows": "composer create-project under/framework mon-projet",
  "linux": "composer create-project under/framework mon-projet"
}
\`\`\`
...
\`\`\`json
{
  "macos": "cd mon-projet && php under serve",
  "windows": "cd mon-projet && php under serve",
  "linux": "cd mon-projet && php under serve"
}
\`\`\`
...
Le répertoire \`app\` contient le code principal de votre application :
